# Generated by Django 3.0.6 on 2020-08-02 23:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('R', 'REGISTRADO'), ('A', 'ACTIVO')], default='R', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('billetera', models.CharField(blank=True, choices=[('E', 'CRIPTOMONEDA EXTERNA'), ('D', 'DISPONIBLE'), ('A', 'ACTIVACION')], default='', max_length=2, null=True)),
                ('tipo', models.CharField(blank=True, choices=[('E', 'ENTRADA'), ('S', 'SALIDA')], default='', max_length=1, null=True)),
                ('concepto', models.CharField(blank=True, choices=[('CP', 'COMISION PLATAFORMA'), ('C1', 'COMISION GENERACION 1'), ('C2', 'COMISION GENERACION 2'), ('C3', 'COMISION GENERACION 3'), ('CI', 'CICLAJE'), ('PN', 'PAGO POR NIVEL'), ('PA', 'PAGO AUTOMATICO POR NIVEL'), ('CS', 'CARGA DE SALDO'), ('RS', 'RETIRO DE SALDO')], default='', max_length=2, null=True)),
